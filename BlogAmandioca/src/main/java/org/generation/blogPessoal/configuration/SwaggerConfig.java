...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.blogPessoal.controllers"))
	...
	private static Contact contact() {
		return new Contact("Amanda Amorim", "https://github.com/amandioca", "amandaamorim.ctt@gmail.com");
	}
